...
\begin{figure}[h!]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Figures/Mesh/Turbogrid_mesh1_CC.png}
    \caption{CC, view 1.}
    \label{fig:turbogrid_cc_1}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Figures/Mesh/Turbogrid_mesh1_CS.png}
    \caption{CS, view 1.}
    \label{fig:turbogrid_cs_1}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
  ...
  \end{subfigure}
  \caption[GV TurboGrid mesh, CC and CS]{Representative TurboGrid mesh for one CC configuration (top row) and one CS configuration (bottom row). The structured O-grid topology is preserved across all 18 GV configurations and the RDT rotor mesh.}
