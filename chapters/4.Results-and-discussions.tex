...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{Figures/Results/fig_4_5_pareto_map.png}
...
\hline
Case & $\Delta H_{\mathrm{sys}}$ (m) & $|\alpha|_{\mathrm{ConeEnd}}$ (deg) & $\mathrm{HL_{total}}$ (m) & $S_{\mathrm{ConeEnd}}$ & Anchor status \\ \hline
\texttt{CS\_500\_8} & $3.23$ & $9.1$  & $1.91$ & $+0.17$ & confirmed \\
\texttt{CS\_500\_6} & $3.33$ & $13.1$ & $1.76$ & $+0.29$ & inconclusive \\
\texttt{CC\_500\_8} & $3.74$ & $16.5$ & $1.37$ & $+0.13$ & confirmed \\
\texttt{CC\_400\_8} & $3.75$ & $21.5$ & $1.31$ & $-0.26$ & not tested \\
\hline
\end{tabular}
\end{table}
