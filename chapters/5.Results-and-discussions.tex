...
A transient simulation of the baseline RDT--GV
...
inside the GV domain are reported as the distance $s$
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\linewidth]{Figures/FFT/01_timeseries_and_window.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{Figures/FFT/02_periodicity_phase_fold.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\linewidth]{Figures/FFT/08_robustness_5_vs_6rev.png}
...
$P_0$ & Cross-section plane at $s = 0$~mm    ($r/R = 0.744$) & Pa & 365 & 196  & 0.54 \\
$P_1$ & Cross-section plane at $s = 100$~mm  ($r/R = 0.744$) & Pa & 576 & 129  & 0.22 \\
$P_2$ & Cross-section plane at $s = 200$~mm  ($r/R = 0.744$) & Pa & 273 & 57.9 & 0.21 \\
$P_3$ & Cross-section plane at $s = 300$~mm  ($r/R = 0.744$) & Pa & 468 & 199  & 0.43 \\
$P_4$ & Cross-section plane at $s = 400$~mm  ($r/R = 0.744$) & Pa & 602 & 85.8 & 0.14 \\
$P_5$ & Cross-section plane at $s = 500$~mm  ($r/R = 0.744$) & Pa & 322 & 46.0 & 0.14 \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\linewidth]{Figures/FFT/comparison_fn_vs_fBPF_all_signals.png}
...
Brekke~\cite{Brekke2015,Brekke2010} associates with significant
...
magnitude. The GV row therefore does not amplify the $m=0$
...
amplitudes through the GV passage is shown in
...
at $r/R = 0.744$ along the GV passage, plotted against the
distance $s$ downstream of the RDT--GV interface.
...
downstream of the GV trailing edge region. The resulting
comparison is plotted in Figure~\ref{fig:coherence_check}.
 
\begin{figure}[H]
\centering
\includegraphics[width=0.99\linewidth]{Figures/FFT/10_coherence_check.png}
...
reasons. First, the RDT inflow field contains a small
...
\begin{itemize}
  ...
  \item The normalised pressure pulsation at $f_{\mathrm{BPF}}$ on
        ...
        of~\cite{Brekke2015,Brekke2010} for the onset of significant
  ...
  \item The ring-coherence diagnostic gives
        ...
        $f_{\mathrm{BPF}}$.
  \item The GV row attenuates rather than amplifies the $m=0$
...
that the lowest wet natural frequency of the GV is well
...
verification step (Chapter~\ref{chap:chap7}).
...
consistently in Brekke~\cite{Brekke2015,Brekke2010},
...
argument:
\begin{enumerate}
  \item It demonstrates that the transient RDT--GV--duct
        ...
        acceptable.
  \item It tests, in the specific RDT--GV geometry of this
        ...
        from~\cite{Brekke2015,Brekke2010}.
\end{enumerate}
 
The final GV design recommended in this thesis is nevertheless
...
of~\cite{Brekke2015,Brekke2010,Nduwayezu2021}. Among the two non-equal
...
The transient simulation of the baseline RDT--GV
...
final GV design is therefore selected from the
