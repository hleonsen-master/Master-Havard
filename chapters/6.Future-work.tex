...
%IKKE BRUK -- turbinmodus-seksjonen under er bare notater og er ikke del av oppgaven. Den er pakket inn i \iffalse ... \fi saa den ikke kompileres (den inneholder ogsaa en dod \ref og en <PLASSHOLDER>). Fjern linjene \iffalse og \fi hvis du senere vil ta den i bruk.
\iffalse
%NOTATER
