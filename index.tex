...
\newcommand{\thesisTitle}{Parametric Hydraulic Design of Guide Vanes for a Rim-Driven Thruster in Pumped-Storage Hydropower}
...
%\phantomsection\include{front/01-preface}           % Preface is optional.                             
\phantomsection\include{front/02-abstract}          % Abstract is mandatory.
\phantomsection\include{front/03-sammendrag}        % Abstract (Bokmål) is mandatory..
\phantomsection\include{front/04-acknowledgments}   % Acknowledgment is optional.
\phantomsection\include{front/04a-disclaimer}       % Disclaimer is mandatory.
...
\phantomsection
\include{front/05-nomenclature}                     % Nomenclature, mandatory.
...
\include{chapters/1.Introduction}                   % Introduction, mandatory.
\include{chapters/2.Literature-review}              % Literature review, mandatory.
%\include{chapters/3.Theory}             % Theory and methods, mandatory.
\include{chapters/3.Theory-and-Methodology}
%\include{chapters/4.Methodology}        % Results and discussions, mandatory.
\include{chapters/4.Results-and-discussions}                   
...
\begin{appendices}
    \titleformat                                    % Redefines header for letter chapter in the appendix.
    	...
    	{}											% Name postamble
    \input{appendix/Appendix-A}                     % Appendix, optional.
